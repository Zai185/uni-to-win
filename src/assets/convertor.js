...
export var tlsMyanmarConverters = new Object();
...
*/
TlsMyanmarConverter.prototype.tlsConvert = function(unicodeText, sourceEncoding = "Unicode", targetEncoding = "WinInnwa") {  
    let winText = ""
    ...
    if (sourceEncoding == "unicode") {  
        ...
        if (targetEncoding == "unicode") {
            winText = converter.convertToUnicode(unicodeText);
        }
        else {
            var converter2 = tlsMyanmarConverters[targetEncoding];
            var unicodeText = converter.convertToUnicode(unicodeText);
            winText = converter2.convertFromUnicode(unicodeText);
        }
    }
